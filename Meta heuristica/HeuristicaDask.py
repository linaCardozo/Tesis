...
def heuristica(iteraciones, hormigas):
    ...
    for j in range(iteraciones):
        ...
        res = dask.delayed(func)(hormigas,tiempoTotal,numDias,numEmpleados,habEmp,tiempoD,feromonas,alpha,beta,habOrde,
                                 qParametro,tiempoDesplazamiento,prioridad,maxDia,costoAns,valorSecuenciaMax,rho)
...
def func(hormigas,tiempoTotal,numDias,numEmpleados,habEmp,tiempoD,feromonas,alpha,beta,
         habOrde,qParametro,tiempoDesplazamiento,prioridad,maxDia,costoAns,valorSecuenciaMax,rho):
