...
def pruebaMetaheuristica(n, iteraciones, hormigas, ordenes):
    ...
    resTiempo = []
    resObj = []
    fileName = "Pruebas/PC Base/Escalabilidad/TempDask/Ordenes" + str(ordenes) + ".txt"
    # fileName = "Pruebas/PC Base/TempSecuencial/Metaheuristica" + str(n) + "N" + str(iteraciones) + "I" + str(hormigas) + "H.txt"
